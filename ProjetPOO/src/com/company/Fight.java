...
public class Fight {
    ...
    private void Fight(int idPlayer1, int idPlayer2, List<Character> characters){
        ...
        while (characters.get(idPlayer1).GetHealthPoint()>0 && (characters.get(idPlayer2).GetHealthPoint()>0)){
            ...
            System.out.println(characters.get(player1).GetName() + " attacks for " + characters.get(player1).GetDamage() + " damage. ");
            ...
            if (characters.get(player2).GetHealthPoint()>0){
                ...
                System.out.println(characters.get(player2).GetName() + " attacks for " + characters.get(player2).GetDamage() + " damage. ");
